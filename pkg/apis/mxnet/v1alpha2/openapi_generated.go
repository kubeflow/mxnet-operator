...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJob": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "MXJob represents the configuration of signal MXJob",
					Properties: map[string]spec.Schema{
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Description: "Specification of the desired behavior of the MXJob.",
								Ref:         ref("github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJobSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Description: "Most recently observed status of the MXJob. This data may not be up to date. Populated by the system. Read-only.",
								Ref:         ref("github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJobStatus"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJobSpec", "github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJobStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJobCondition": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						"type": {
							SchemaProps: spec.SchemaProps{
								Description: "Type of MXJob condition.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
		...
		"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJobList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "MXJobList is a list of MXJobs.",
					Properties: map[string]spec.Schema{
						"kind": {
							SchemaProps: spec.SchemaProps{
								Description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								Description: "List of MXJobs.",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJob"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJobSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						"cleanPodPolicy": {
							SchemaProps: spec.SchemaProps{
								Description: "CleanPodPolicy defines the policy to kill pods after MXJob is succeeded. Default to Running.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
			...
			Dependencies: []string{
				"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXReplicaSpec"},
		},
		"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJobStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "MXJobStatus represents the current observed state of the MXJob.",
					Properties: map[string]spec.Schema{
						"conditions": {
							SchemaProps: spec.SchemaProps{
								Description: "Conditions is an array of current observed MXJob conditions.",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJobCondition"),
										},
									},
								},
							},
						...
						"mxReplicaStatuses": {
							SchemaProps: spec.SchemaProps{
								Description: "MXReplicaStatuses is map of MXReplicaType and MXReplicaStatus, specifies the status of each MXReplica.",
								Type:        []string{"object"},
								AdditionalProperties: &spec.SchemaOrBool{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXReplicaStatus"),
										},
									},
								},
							},
						...
						"startTime": {
							SchemaProps: spec.SchemaProps{
								Description: "Represents time when the MXJob was acknowledged by the MXJob controller. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.",
								Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
							},
						},
						"completionTime": {
							SchemaProps: spec.SchemaProps{
								Description: "Represents time when the MXJob was completed. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.",
								Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
							},
						},
						"lastReconcileTime": {
							SchemaProps: spec.SchemaProps{
								Description: "Represents last time when the MXJob was reconciled. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.",
								Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
							},
						},
					},
					Required: []string{"conditions", "mxReplicaStatuses"},
				},
			},
			Dependencies: []string{
				"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXJobCondition", "github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXReplicaStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
		},
		"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXReplicaSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"template": {
							SchemaProps: spec.SchemaProps{
								Description: "Template is the object that describes the pod that will be created for this MXReplica. RestartPolicy in PodTemplateSpec will be overide by RestartPolicy in MXReplicaSpec",
								Ref:         ref("k8s.io/api/core/v1.PodTemplateSpec"),
							},
						},
						"restartPolicy": {
							SchemaProps: spec.SchemaProps{
								Description: "Restart policy for all MXReplicas within the MXJob. One of Always, OnFailure, Never and ExitCode. Default to Never.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
		...
		"github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2.MXReplicaStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "MXReplicaStatus represents the current observed state of the MXReplica.",
					Properties: map[string]spec.Schema{
						"active": {
							SchemaProps: spec.SchemaProps{
