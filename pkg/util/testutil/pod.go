...
var (
	controllerKind = mxv1alpha2.SchemeGroupVersionKind
)

func NewBasePod(name string, mxJob *mxv1alpha2.MXJob, t *testing.T) *v1.Pod {
	return &v1.Pod{
...
func NewPod(mxJob *mxv1alpha2.MXJob, typ string, index int, t *testing.T) *v1.Pod {
...
func NewPodList(count int32, status v1.PodPhase, mxJob *mxv1alpha2.MXJob, typ string, start int32, t *testing.T) []*v1.Pod {
	pods := []*v1.Pod{}
...
func SetPodsStatuses(podIndexer cache.Indexer, mxJob *mxv1alpha2.MXJob, typ string, pendingPods, activePods, succeededPods, failedPods int32, t *testing.T) {
	var index int32
