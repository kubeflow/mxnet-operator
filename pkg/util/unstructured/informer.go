...
import (
	...
	informer "github.com/kubeflow/mxnet-operator/pkg/client/informers/externalversions/kubeflow/v1alpha2"
	lister "github.com/kubeflow/mxnet-operator/pkg/client/listers/kubeflow/v1alpha2"
)
...
func NewMXJobInformer(resource *metav1.APIResource, client dynamic.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) informer.MXJobInformer {
