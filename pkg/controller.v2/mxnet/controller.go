...
type MXController struct {
	...
	updateStatusHandler func(mxjob *mxv1alpha2.MXJob) error

	// To allow injection of deleteMXJob for testing.
	deleteMXJobHandler func(mxjob *mxv1alpha2.MXJob) error
...
func NewMXController(
	...
	mxJobInformer mxjobinformersv1alpha2.MXJobInformer,
	...
	jc := jobcontroller.NewJobController(tc, metav1.Duration{Duration: 15 * time.Second},
		option.EnableGangScheduling, kubeClientSet, kubeInformerFactory, mxv1alpha2.Plural)
	tc.JobController = jc
	// Set sync handler.
...
func (tc *MXController) reconcileMXJobs(mxjob *mxv1alpha2.MXJob) error {
...
// manager.
func (tc *MXController) satisfiedExpectations(mxjob *mxv1alpha2.MXJob) bool {
	satisfied := false
...
func (tc *MXController) GetJobFromAPIClient(namespace, name string) (metav1.Object, error) {
	return tc.mxJobClientSet.KubeflowV1alpha2().MXJobs(namespace).Get(name, metav1.GetOptions{})
}

func (tc *MXController) GetAPIGroupVersionKind() schema.GroupVersionKind {
	return mxv1alpha2.SchemeGroupVersionKind
}

func (tc *MXController) GetAPIGroupVersion() schema.GroupVersion {
	return mxv1alpha2.SchemeGroupVersion
}
