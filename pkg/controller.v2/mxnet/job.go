	...
	if err != nil {
		...
		if err == errFailedMarshal {
			...
			status := mxv1alpha2.MXJobStatus{
				Conditions: []mxv1alpha2.MXJobCondition{
					mxv1alpha2.MXJobCondition{
						Type:               mxv1alpha2.MXJobFailed,
