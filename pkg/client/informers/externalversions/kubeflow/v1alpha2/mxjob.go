...
import (
	...
	mxnetv1alpha2 "github.com/kubeflow/mxnet-operator/pkg/apis/mxnet/v1alpha2"
	...
	v1alpha2 "github.com/kubeflow/mxnet-operator/pkg/client/listers/kubeflow/v1alpha2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.KubeflowV1alpha2().MXJobs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.KubeflowV1alpha2().MXJobs(namespace).Watch(options)
			},
		},
		&mxnetv1alpha2.MXJob{},
		resyncPeriod,
...
func (f *mXJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mxnetv1alpha2.MXJob{}, defaultMXJobInformer)
}

func (f *mXJobInformer) Lister() v1alpha2.MXJobLister {
	return v1alpha2.NewMXJobLister(f.Informer().GetIndexer())
}
