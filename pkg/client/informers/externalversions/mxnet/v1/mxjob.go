...
import (
	...
	v1 "github.com/kubeflow/mxnet-operator/pkg/client/listers/mxnet/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeflowV1().MXJobs(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeflowV1().MXJobs(namespace).Watch(options)
			},
		},
		&mxnetv1.MXJob{},
		resyncPeriod,
...
func (f *mXJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mxnetv1.MXJob{}, f.defaultInformer)
}
