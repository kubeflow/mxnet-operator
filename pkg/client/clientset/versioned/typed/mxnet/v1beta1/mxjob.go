...
type MXJobInterface interface {
	Create(*v1beta1.MXJob) (*v1beta1.MXJob, error)
	Update(*v1beta1.MXJob) (*v1beta1.MXJob, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.MXJob, error)
	List(opts v1.ListOptions) (*v1beta1.MXJobList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.MXJob, err error)
	MXJobExpansion
}
...
func newMXJobs(c *KubeflowV1beta1Client, namespace string) *mXJobs {
	return &mXJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *mXJobs) Get(name string, options v1.GetOptions) (result *v1beta1.MXJob, err error) {
	result = &v1beta1.MXJob{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mxjobs").
		Name(name).
...
func (c *mXJobs) List(opts v1.ListOptions) (result *v1beta1.MXJobList, err error) {
	result = &v1beta1.MXJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mxjobs").
...
func (c *mXJobs) Create(mXJob *v1beta1.MXJob) (result *v1beta1.MXJob, err error) {
	result = &v1beta1.MXJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mxjobs").
...
func (c *mXJobs) Update(mXJob *v1beta1.MXJob) (result *v1beta1.MXJob, err error) {
	result = &v1beta1.MXJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mxjobs").
...
func (c *mXJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.MXJob, err error) {
	result = &v1beta1.MXJob{}
