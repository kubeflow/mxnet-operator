...
var mxjobsResource = schema.GroupVersionResource{Group: "kubeflow.org", Version: "v1beta1", Resource: "mxjobs"}

var mxjobsKind = schema.GroupVersionKind{Group: "kubeflow.org", Version: "v1beta1", Kind: "MXJob"}
...
func (c *FakeMXJobs) Get(name string, options v1.GetOptions) (result *v1beta1.MXJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(mxjobsResource, c.ns, name), &v1beta1.MXJob{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.MXJob), err
}
...
func (c *FakeMXJobs) List(opts v1.ListOptions) (result *v1beta1.MXJobList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(mxjobsResource, mxjobsKind, c.ns, opts), &v1beta1.MXJobList{})
...
func (c *FakeMXJobs) Create(mXJob *v1beta1.MXJob) (result *v1beta1.MXJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(mxjobsResource, c.ns, mXJob), &v1beta1.MXJob{})
...
func (c *FakeMXJobs) Update(mXJob *v1beta1.MXJob) (result *v1beta1.MXJob, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(mxjobsResource, c.ns, mXJob), &v1beta1.MXJob{})
...
func (c *FakeMXJobs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(mxjobsResource, c.ns, name), &v1beta1.MXJob{})
...
func (c *FakeMXJobs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.MXJobList{})
	return err
}
