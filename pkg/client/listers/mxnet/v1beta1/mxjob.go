...
// List lists all MXJobs in the indexer.
func (s *mXJobLister) List(selector labels.Selector) (ret []*v1beta1.MXJob, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.MXJob))
	})
	return ret, err
}
...
// List lists all MXJobs in the indexer for a given namespace.
func (s mXJobNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.MXJob, err error) {
...
// Get retrieves the MXJob from the indexer for a given namespace and name.
func (s mXJobNamespaceLister) Get(name string) (*v1beta1.MXJob, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("mxjob"), name)
	}
	return obj.(*v1beta1.MXJob), nil
}
