	...
	testCases := []testCase{
		{
			...
			mxJob:                      testutil.NewMXJobWithSuccessPolicy(0, 1, 0, mxv1beta1.SuccessPolicyDefault),
		...
		},
		{
			...
			mxJob:                      testutil.NewMXJobWithSuccessPolicy(1, 1, 0, mxv1beta1.SuccessPolicyDefault),
			expectedFailedScheduler:    0,
		...
		},
		{
			...
			mxJob:                      testutil.NewMXJobWithSuccessPolicy(1, 4, 0, mxv1beta1.SuccessPolicyDefault),
			expectedFailedScheduler:    0,
			expectedSucceededScheduler: 0,
			expectedActiveScheduler:    1,
			expectedFailedWorker:       0,
		...
		{
			description:                "Worker is succeeded, successPolicy sets to AllWorkers",
		...
		{
			description:                "Worker is running, successPolicy sets to AllWorkers",
			mxJob:                      testutil.NewMXJobWithSuccessPolicy(1, 1, 0, mxv1beta1.SuccessPolicyAllWorkers),
			expectedFailedScheduler:    0,
			expectedSucceededScheduler: 0,
			expectedActiveScheduler:    1,
